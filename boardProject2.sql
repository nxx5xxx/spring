...
select * from user_table where user_id = 'test1' and user_pw =1234;

insert into user_table values(user_seq.nextval,'테스트1','test1','1234');
insert into user_table values(user_seq.nextval,'테스트2','test2','2345');
commit;
