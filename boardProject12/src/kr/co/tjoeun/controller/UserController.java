...
public class UserController {
	...
	public String modify(@ModelAttribute("modifyUserBean") UserBean userBean) {
		...
		//model.addAttribute("modifyUserBean", userBean);
		return "user/modify";
	}
	
	@PostMapping("/modify_procedure")
	public String modifyProcedure(@Valid @ModelAttribute("modifyUserBean") UserBean modifyUserBean,BindingResult result) {
		if(result.hasErrors()) {
