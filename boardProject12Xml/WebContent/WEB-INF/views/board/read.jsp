			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<c:if test="${readContentBean.content_file==null }"><br>첨부된 이미지가 없습니다</c:if>
						<c:if test="${readContentBean.content_file!=null }"><img src="${root }upload/${readContentBean.content_file }" width="100%"/></c:if>						
					</div>
					<div class="form-group">
